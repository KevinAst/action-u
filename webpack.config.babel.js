...
const webpackConfig = {
  ...
  output: {
    ...
    filename:      packageInfo.name + (productionEnv ? '.min.js' : '.js'), // bundleFileName ... ex: action-u.min.js

    library:       libraryName(), // bundle as a library (i.e. for external consumption) ....... ex: ActionU
